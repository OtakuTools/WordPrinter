def getColorStyle():
    return {
        ...
        'F50001':'modifyDate.index1',#(245,0,1)
        'F50002':'modifyDate.index2',#(245,0,2)
        'F50003':'modifyDate.index3',#(245,0,3)
        'F50004':'modifyDate.index4',#(245,0,4)
        'F50005':'modifyDate.index5',#(245,0,5)
        'F40000':'zip',         #(244,0,0)
        ...
        'EB0000':'organization.Audit.auditLeader', #(235,0,0)
        'EA0000':'organization.Audit.audit1',      #(234,0,0)
        'E90000':'organization.Audit.audit2',      #(233,0,0)
        'E80000':'organization.Audit.audit3',      #(232,0,0)
        'E70000':'organization.Audit.planDate',    #(231,0,0)
        'E60000':'organization.Audit.auditDate',   #(230,0,0)
        'E50000':'organization.Audit.scheduleDate',#(229,0,0)
        'E40000':'organization.Audit.compiler',    #(228,0,0)
        'E30000':'organization.Audit.compileDate', #(227,0,0)
        'E20000':'organization.Audit.audit',       #(226,0,0)
        'E10000':'organization.Audit.approveDate', #(225,0,0)
        'E00000':'organization.Audit.reviewDate',  #(224,0,0)
        'DF0000':'organization.Audit.excuteDate',  #(223,0,0)
        'DE0000':'organization.Audit.reportDate',  #(222,0,0)
        'DD0000':'organization.Record.fileName',    #(221,0,0)
        'DC0000':'organization.Record.auditContent',#(220,0,0)
        'DB0000':'organization.Record.auditProcess',#(219,0,0)
        'DA0000':'organization.Record.audit',       #(218,0,0)
