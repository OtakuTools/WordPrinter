class databaseTableConfig:
    tables = [
        ...
        CREATE TABLE IF NOT EXISTS department( 
            ...
            intro NVARCHAR(2000) NOT NULL,
            func NVARCHAR(1000) NOT NULL,
            seq INT(5) NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS projectInfo(
            ...
            Damount nvarchar(30),
            Dperiod nvarchar(30),
            Dconfig nvarchar(1000),
            Dname nvarchar(30),
            Dlevel nvarchar(10),
            Ddetails nvarchar(1000),
            Ddemand nvarchar(1000),
            Dddl nvarchar(1000),
            TstartTime nvarchar(30),
            Trequire nvarchar(1000),
            TPM nvarchar(30),
            TTM nvarchar(30),
            seq int,
        ...
        CREATE TABLE IF NOT EXISTS serviceProcess(
            ...
            CotProcess nvarchar(1000),
            CotResult nvarchar(1000),
            CotDate nvarchar(30),
        ...
        CREATE TABLE IF NOT EXISTS organization(
            ...
            AudRepoCompDate nvarchar(30),
            AudRepoApprDate nvarchar(30),
            ...
            RecTime nvarchar(30),
            RecStaff nvarchar(100),
            RecArrange nvarchar(1000),
            RecContent nvarchar(1000),
            RecFileName nvarchar(100),
            RecAuditContent nvarchar(1000),
            RecAuditProcess nvarchar(1000),
